...
使用方法：
    python scripts/train_rf.py [data_file]
...
from ai_scorer.models import RandomForestScorer
from ai_scorer.utils import load_data, print_data_stats


def main():
    print("=" * 60)
    print("🦞 AI回复质量评分器 - 随机森林训练")
    print("=" * 60)
    ...
    print(f"              预测为真人  预测为AI")
    print(f"实际真人      {cm[0][0]:>8}  {cm[0][1]:>8}")
    print(f"实际AI        {cm[1][0]:>8}  {cm[1][1]:>8}")
